...
using static CleanMusicMaker.Services.AudioService.SpeechService;

namespace CleanMusicMaker.Services
{
    public class AudioService : IAudioService
    {
        private readonly SpeechConfiguration _speechConfig;

        public AudioService(IOptions<SpeechConfiguration> options)
        {
            _speechConfig = options.Value ?? throw new ArgumentNullException(nameof(options));
        }

        public async Task<SpeechResult?> ExtractTextContent(IFormFile file)
        {
            var speechResult = new SpeechResult(null);
            ...
            recognizer.Recognized += (s, e) =>
            {
                ...
                {
                    speechResult = new SpeechResult(e.Result.Text);
                }               
            };
